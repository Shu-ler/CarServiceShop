...
Функция Обновить(ИмяФайла) Экспорт
	...
	ИмяСправочника = Метаданные.Справочники.КА2_Комплектации.Имя;
...
Функция Некорректные() Экспорт
	...
	Возврат КА2_КаталогАвтомобилейВызовСервера.КоллекцияНекорректных(Метаданные.Справочники.КА2_Комплектации.Имя);
